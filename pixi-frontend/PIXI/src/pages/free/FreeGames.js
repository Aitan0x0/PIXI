...
export default function FreeGames() {
    ...
    const freeGames = useMemo(() => games.filter(game => game.gameNewPrice === 0), [games])
    ...
    return (
        <>
            <div className="header-cat-games">
                <div className="cat-img"><img src="/img-store-header/free_games.jpg" alt="" />
                    <div className="cat-img-grad"></div>
                    <p className="cat-name-p">FREE GAMES</p>
                </div>
            </div>

            <div className="right-side-container">
                <FiltredGames cats={cats} games={freeGames} filterGame={FilteredGameFunk} site={"freeGames"} />
