...
export default function DiscountedGames() {
    ...
    //
    const freeGames = useMemo(() => games.filter(game =>game.gameOldPrice!==0 && game.gameNewPrice<game.gameOldPrice), [games])
    ...
    return (
        <>
            <div className="header-cat-games">
                <div className="cat-img"><img src="/img-store-header/discounted_games.jpg" alt="" />
                    <div className="cat-img-grad"></div>
                    <p className="cat-name-p">DISCOUNTED GAMES</p>
                </div>
            </div>

            <div className="right-side-container">
                <FiltredGames cats={cats} games={freeGames} filterGame={FilteredGameFunk} site={"discounted"} />
